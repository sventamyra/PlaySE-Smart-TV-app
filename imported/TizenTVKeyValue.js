...
Common.API.TVKeyValue = function(){
    ...
    this.KEY_MENU = 18;
    this.KEY_WLINK = 10071; //home panel
    this.KEY_CC = null;
	...
	this.KEY_GUIDE = null;
	this.KEY_SUBTITLE = 10221;
	this.KEY_ASPECT = 10140; //screen size 
	this.KEY_MTS = 10195;
    this.KEY_12 =1057;
    ...
    this.KEY_SEARCH =10225; //smart search
    ...
    // Add for Smart Control
    this.KEY_BT_NUMBER =10193;
    this.KEY_BT_HOTKEY= 10162;

    // Add for smart Control
    this.KEY_RECOMMEND_SEARCH_TOGGLE =10192; //recommend & search
    
    this.KEY_PAGEMODE = null;
